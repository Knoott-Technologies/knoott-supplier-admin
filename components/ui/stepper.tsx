...
import { CheckIcon, LoaderCircleIcon, LucideIcon } from "lucide-react";
...
function StepperSeparator({
  ...
  return (
    <div
      ...
      className={cn(
        "bg-muted group-data-[state=completed]/step:bg-success m-0.5 group-data-[orientation=horizontal]/stepper:h-0.5 group-data-[orientation=horizontal]/stepper:w-full group-data-[orientation=horizontal]/stepper:flex-1 group-data-[orientation=vertical]/stepper:h-12 group-data-[orientation=vertical]/stepper:w-0.5",
        className
      )}
      {...props}
    />
