...
interface ShopifyConnectedStoresProps {
  integration: Database["public"]["Tables"]["shopify_integrations"]["Row"];
  businessId: string;
}
  ...
  return (
    <div className="grid gap-4 w-full">
      <Card className="w-full" key={integration.id}>
        ...
        <CardFooter className="flex justify-end border-t bg-destructive/10">
          <AlertDialog>
            ...
            <AlertDialogContent>
              ...
              <AlertDialogFooter>
                ...
                <AlertDialogAction
                  className="bg-destructive/10 text-destructive hover:bg-destructive hover:text-background"
