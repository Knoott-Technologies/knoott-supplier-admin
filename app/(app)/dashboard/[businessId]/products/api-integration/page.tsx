...
export default async function ApiIntegrationPage({
  ...
  const response = await fetch(
    `${process.env.NEXT_PUBLIC_APP_URL}/api/businesses/${params.businessId}/api-integration`,
    {
      method: "GET",
      headers: {
  ...
  return (
    <main className="h-fit w-full md:max-w-2xl px-3 md:px-0 py-5 pb-14 lg:py-7 mx-auto no-scrollbar">
      ...
      />
      <ApiIntegrationForm businessId={params.businessId} initialData={configData} />
    </main>
  );
}
