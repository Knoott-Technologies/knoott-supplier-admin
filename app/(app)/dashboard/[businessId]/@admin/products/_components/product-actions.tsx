            ...
            <div className="flex h-full w-full flex-col">
              ...
              <div className="w-full py-3 bg-background flex flex-col gap-y-2">
                ...
                <div className="w-full h-fit items-start justify-start flex flex-col gap-y-2 px-3">
                  ...
                  >
                    <Link
                      href={`/dashboard/${businessId}/products/${product.id}/edit`}
                      className="w-full"
                    >
                  ...
                  >
                    <Link
                      href={`/dashboard/${businessId}/products/${product.id}`}
                    >
                      Ver detalles
        ...
        <DropdownMenuContent align="end" className="min-w-[200px]">
          ...
          <DropdownMenuItem
            ...
            onClick={() => {
              ...
              router.push(
                `/dashboard/${businessId}/products/${product.id}/edit`
              );
            }}
            disabled={isInReview}
          >
          ...
          <DropdownMenuItem
            ...
            asChild
          >
            <Link href={`/dashboard/${businessId}/products/${product.id}`}>
              Ver detalles
              <ArrowRight className="!size-3.5" />
            </Link>
          </DropdownMenuItem>
